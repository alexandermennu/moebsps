...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('sir.srgbv.public-reporters') }}" class="inline-flex items-center gap-2 bg-white border border-green-300 hover:bg-green-50 text-green-700 font-medium px-4 py-2 rounded-lg text-sm transition">
    ...
    <div class="bg-red-50 border border-red-200 rounded-lg p-4 flex items-center gap-3">
        ...
        <a href="{{ route('sir.srgbv.dashboard', ['urgent' => '1']) }}" class="shrink-0 text-sm font-medium text-red-700 hover:text-red-800 flex items-center gap-1">
            View Cases
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    info.update = function(props) {
        ...
        this._div.innerHTML = props
            ? `<h4>${displayName}</h4><p>${count} case${count !== 1 ? 's' : ''} reported</p>`
    ...
    fetch('/data/liberia-counties.json')
        ...
        .catch(error => {
            ...
            // Fallback: just center on Liberia
