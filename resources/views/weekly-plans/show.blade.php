            ...
            <div class="space-y-4">
                @if($weeklyPlan->objectives)
                    <div>
                        ...
                        <div class="text-sm text-gray-600 whitespace-pre-line bg-gray-50 rounded-md p-3">{{ $weeklyPlan->objectives }}</div>
                    </div>
                @endif
                ...
                @if($weeklyPlan->expected_outcomes)
                    <div>
                        ...
                        <div class="text-sm text-gray-600 whitespace-pre-line bg-gray-50 rounded-md p-3">{{ $weeklyPlan->expected_outcomes }}</div>
                    </div>
                @endif
                ...
                @if($weeklyPlan->resources_needed)
                    <div>
                        ...
                        <div class="text-sm text-gray-600 whitespace-pre-line bg-gray-50 rounded-md p-3">{{ $weeklyPlan->resources_needed }}</div>
                    </div>
                @endif
            </div>
        </div>
