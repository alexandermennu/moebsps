...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-800">SRGBV Dashboard</h2>
            <p class="text-sm text-gray-500">School-Related Gender-Based Violence overview and statistics</p>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('srgbv.cases.index') }}" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-50">
                📋 View Cases
            </a>
            <a href="{{ route('srgbv.cases.create') }}" class="px-4 py-2 bg-red-700 text-white text-sm font-medium rounded-md hover:bg-red-800">
                + Report Case
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-4 max-w-xs">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-800 mb-4">Cases by Status</h3>
            <div class="space-y-3">
        ...
        {{-- Cases by Category --}}
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-800 mb-4">Cases by Category</h3>
            <div class="space-y-3">
        ...
        {{-- Cases by Priority --}}
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-800 mb-4">Cases by Priority</h3>
        ...
        {{-- Monthly Trend --}}
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-800 mb-4">Monthly Trend (Last 12 Months)</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-sm font-semibold text-gray-800">Recent Cases</h3>
                <a href="{{ route('srgbv.cases.index') }}" class="text-xs text-red-600 hover:text-red-800">View all →</a>
            </div>
            ...
            @else
                <div class="space-y-3">
                    @foreach($recentCases as $case)
                        <a href="{{ route('srgbv.cases.show', $case) }}" class="block p-3 bg-gray-50 border border-gray-100 rounded-md hover:bg-gray-100">
        ...
        {{-- Follow-up Due --}}
        <div class="bg-white rounded-lg border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-800 mb-4">⏰ Cases Requiring Follow-up</h3>
            ...
            @else
                <div class="space-y-3">
                    @foreach($followUpCases as $case)
                        <a href="{{ route('srgbv.cases.show', $case) }}" class="block p-3 {{ $case->follow_up_date && $case->follow_up_date->isPast() ? 'bg-red-50 border border-red-200' : 'bg-amber-50 border border-amber-200' }} rounded-md hover:opacity-90">
                            <div class="flex items-center justify-between">
                                <div>
