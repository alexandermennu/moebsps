...
<div class="max-w-4xl">
    ...
    <form method="POST" action="{{ route('srgbv.cases.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Case Information</h3>
        ...
        <div class="bg-white border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Victim Information</h3>
        ...
        <div class="bg-white border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Case Assignment</h3>
        ...
        <div class="bg-white border border-gray-200 p-6">
            <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Supporting Evidence</h3>
        ...
        <div class="flex gap-3">
            <button type="submit" class="px-6 py-2.5 bg-red-700 text-white text-sm font-medium hover:bg-red-800">
                Submit Report
            </button>
            <a href="{{ route('srgbv.cases.index') }}" class="px-6 py-2.5 bg-white border border-gray-300 text-gray-700 text-sm font-medium hover:bg-gray-50">
                Cancel
            </a>
        </div>
    </form>
