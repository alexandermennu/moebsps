...
<div class="max-w-2xl">
    ...
    <div class="bg-white border border-gray-200 p-6">
        <h2 class="text-sm font-semibold text-gray-900 uppercase tracking-wide border-b border-gray-200 pb-2 mb-6">Create New Division</h2>
        ...
        <form method="POST" action="{{ route('admin.divisions.store') }}">
            ...
            <div class="flex gap-3">
                <button type="submit" class="px-4 py-2 bg-slate-800 text-white text-sm font-medium hover:bg-slate-700">Create Division</button>
