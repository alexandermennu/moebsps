            ...
            <div id="counselor-fields" class="mb-4 p-4 bg-blue-50 border border-blue-200" style="display: none;">
                ...
                <div class="grid grid-cols-3 gap-4 mb-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="nationality" value="{{ old('nationality', $user->nationality) }}" placeholder="e.g. Liberian"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="city" value="{{ old('city', $user->city) }}" placeholder="e.g. Monrovia"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                </div>
                <div class="grid grid-cols-3 gap-4 mb-3">
                ...
                <div class="grid grid-cols-2 gap-4 mb-3">
                    <div>
                        ...
                        <input type="date" name="counselor_assignment_date" value="{{ old('counselor_assignment_date', $user->counselor_assignment_date?->format('Y-m-d')) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">School District</label>
                        <input type="text" name="counselor_school_district" value="{{ old('counselor_school_district', $user->counselor_school_district) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-3">
                    <div>
                        ...
                        <input type="text" name="counselor_school_address" value="{{ old('counselor_school_address', $user->counselor_school_address) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Principal / Head Teacher</label>
                        <input type="text" name="counselor_school_principal" value="{{ old('counselor_school_principal', $user->counselor_school_principal) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                </div>
                <div class="grid grid-cols-3 gap-4 mb-3">
                    <div>
                        ...
                        <select name="counselor_school_level" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                            ...
                            @foreach(\App\Models\User::SCHOOL_LEVELS as $key => $label)
                                <option value="{{ $key }}" {{ old('counselor_school_level', $user->counselor_school_level) === $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="counselor_school_type" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                            ...
                            @foreach(\App\Models\User::SCHOOL_TYPES as $key => $label)
                                <option value="{{ $key }}" {{ old('counselor_school_type', $user->counselor_school_type) === $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Student Population</label>
                        <input type="number" name="counselor_school_population" value="{{ old('counselor_school_population', $user->counselor_school_population) }}" min="0" max="50000"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4 mb-3">
                    <div>
                        ...
                        <input type="number" name="counselor_num_boys" value="{{ old('counselor_num_boys', $user->counselor_num_boys) }}" min="0" max="50000"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">No. of Girls</label>
                        <input type="number" name="counselor_num_girls" value="{{ old('counselor_num_girls', $user->counselor_num_girls) }}" min="0" max="50000"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-500">
                    </div>
                </div>
