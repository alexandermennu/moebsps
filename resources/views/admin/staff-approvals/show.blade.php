...
<div class="max-w-2xl">
    <div class="mb-6">
        <a href="{{ route('admin.staff-approvals.index') }}" class="text-sm text-gray-500 hover:text-gray-700">← Back to Pending Approvals</a>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
        ...
        <div class="flex items-start justify-between">
            ...
            <span class="text-xs px-3 py-1 rounded-full bg-amber-100 text-amber-700 font-medium">⏳ Pending Approval</span>
        </div>
        ...
        <div class="border-t border-gray-200 pt-6 space-y-4">
            ...
            <div class="flex gap-3">
                ...
                <form method="POST" action="{{ route('admin.staff-approvals.approve', $user) }}"
                    ...
                    @csrf
                    <button type="submit" class="inline-flex items-center px-5 py-2 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700">
                        ✓ Approve
                    </button>
                </form>
                ...
                <button type="button" onclick="document.getElementById('rejectForm').classList.toggle('hidden')"
                        class="inline-flex items-center px-5 py-2 bg-red-600 text-white text-sm font-medium rounded-md hover:bg-red-700">
                    ✗ Reject
                </button>
            </div>
            ...
            <form id="rejectForm" method="POST" action="{{ route('admin.staff-approvals.reject', $user) }}" class="hidden">
                ...
                <div class="bg-red-50 border border-red-200 rounded-md p-4">
                    ...
                    @enderror
                    <button type="submit" class="mt-3 px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-md hover:bg-red-700">
                        Confirm Rejection
                    </button>
                </div>
            </form>
