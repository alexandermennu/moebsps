...
<div class="p-6">
    ...
    {{-- View Tabs --}}
    <div class="flex items-center justify-between mb-3 border-b border-slate-200">
        ...
        <div class="flex items-center gap-2 pb-2">
            <div class="flex items-center gap-1.5 px-2 py-1 bg-blue-50 rounded-md">
                ...
                <span class="text-xs font-semibold text-blue-700">{{ $pendingCount }}</span>
                <span class="text-xs text-blue-600">Active</span>
            </div>
            @if($overdueCount > 0)
            <div class="flex items-center gap-1.5 px-2 py-1 bg-red-50 rounded-md">
                ...
                <span class="text-xs font-semibold text-red-700">{{ $overdueCount }}</span>
                <span class="text-xs text-red-600">Overdue</span>
            </div>
            @endif
            <div class="flex items-center gap-1.5 px-2 py-1 bg-orange-50 rounded-md">
                <svg class="w-3.5 h-3.5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                <span class="text-xs font-semibold text-orange-700">{{ $todayPendingCount }}</span>
                <span class="text-xs text-orange-600">Today</span>
            </div>
            <div class="flex items-center gap-1.5 px-2 py-1 bg-green-50 rounded-md">
                ...
                <span class="text-xs font-semibold text-green-700">{{ $completedCount }}</span>
