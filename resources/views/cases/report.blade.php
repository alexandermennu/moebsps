...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {{-- SRGBV Cases Card --}}
        @if($canAccessSrgbv)
        <a href="{{ route('srgbv.dashboard') }}" class="group block bg-white border-2 border-red-200 hover:border-red-500 hover:shadow-lg transition-all p-6">
            <div class="flex items-start gap-4">
                <div class="w-14 h-14 bg-red-100 flex items-center justify-center flex-shrink-0 group-hover:bg-red-200 transition">
        ...
        @else
        <div class="bg-gray-50 border-2 border-gray-200 p-6 opacity-60">
            <div class="flex items-start gap-4">
                <div class="w-14 h-14 bg-gray-100 flex items-center justify-center flex-shrink-0">
        ...
        {{-- Other Cases Card --}}
        <div class="group block bg-white border-2 border-blue-200 p-6 relative">
            <div class="flex items-start gap-4">
                <div class="w-14 h-14 bg-blue-100 flex items-center justify-center flex-shrink-0">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-4">
                        <span class="inline-flex items-center gap-1 px-1.5 py-0.5 bg-blue-50 text-blue-600 text-[10px] font-medium">
